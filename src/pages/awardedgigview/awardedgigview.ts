...
import { IonicPage,ModalController,NavController,NavParams, Nav, AlertController, Platform } from 'ionic-angular';
...
/**
 * Generated class for the AwardedgigviewPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-awardedgigview',
  templateUrl: 'awardedgigview.html',
})
export class AwardedgigviewPage {
...
this.profileProvider.getUserDetails().child("saved").on("value", bookmarkListSnapshot => {
  ...
  */
  ...
  if (this.platform.is('android')) {
    window.open('geo://' + 18.518070 + ',' + 73.815376 + '?q='+'MIT Pune');
  }
 }

 callOrganiser(){
   window.open('tel:+91 88799 44277');
 }
